...
import {ApiPropertyAccountUsername} from "../../../routes/v1/account.js"



export class InitiateCertificateBasedAuthentication {
	@ApiPropertyAccountUsername readonly username: string
}
...
//
//
//	constructor(prisma: PrismaService, cacheManager: CacheManager) {
//		this.prisma       = prisma
...
//
//	@ApiOperation({
//		summary:     'Initiate certificate based authentication',
//		operationId: "request-proof-of-possession-of-private-key",
//	}) @ApiBody({type: InitiateCertificateBasedAuthentication}) @Post('/initiate')
...
//
//	@ApiOperation({
//		summary:     'Verify proof of possession of Private Key',
//		operationId: "verify-possession-of-private-key",
//	}) @Post('/verify')
