...
describe('AccountController', () =>
{
    ...
    beforeEach(async () =>
               {
                   ...
                   prismaClient = createPrismaMock({account: [accountWhichTakenUsername]}, Prisma.dmmf.datamodel,
    ...
    describe('register', () =>
    {
        ...
        {
            expect(accountController.register({password: 'password'} as any))
                .rejects
        ...
        {
            expect(accountController.register({username: 'test'} as any))
                .rejects
                .toThrowError('Username and password are required');
        });
