...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::Mechanism => ColumnType::Text.def(),
            Self::MechanismDesciption => ColumnType::Text.def().null(),
            Self::OnsetMechanism => ColumnType::Text.def(),
            Self::OnsetDescription => ColumnType::Text.def().null(),
            Self::DeclineMechanism => ColumnType::Text.def(),
            Self::DeclineDescription => ColumnType::Text.def().null(),
            Self::OnsetDuration => ColumnType::Text.def().null(),
            Self::DeclineToBaselineDuration => ColumnType::Text.def().null(),
            Self::DeclineToHalfDuration => ColumnType::Text.def().null(),
        }
    }
}
