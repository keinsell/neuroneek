...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::FirstName => ColumnType::Text.def().null(),
            Self::LastName => ColumnType::Text.def().null(),
            Self::DateOfBirth => ColumnType::custom("datetime").def().null(),
            Self::Weight => ColumnType::Integer.def().null(),
            Self::Height => ColumnType::Integer.def().null(),
            Self::AccountId => ColumnType::Text.def().null(),
        }
    }
}
