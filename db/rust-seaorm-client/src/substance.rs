...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::BrandNames => ColumnType::Text.def(),
            Self::SubstitutiveName => ColumnType::Text.def().null(),
            Self::SystematicName => ColumnType::Text.def(),
            Self::PubchemCid => ColumnType::Integer.def(),
            Self::Unii => ColumnType::Text.def().null(),
            Self::CasNumber => ColumnType::Text.def().null(),
            Self::InchiKey => ColumnType::Text.def(),
            Self::Smiles => ColumnType::Text.def(),
...
pub enum RelatedEntity {
    ...
    Ingestion,
    #[sea_orm(entity = "super::psychoactive_class::Entity")]
    PsychoactiveClass,
    #[sea_orm(entity = "super::stash::Entity")]
    Stash,
    #[sea_orm(entity = "super::substance_interactions::Entity")]
    SubstanceInteractions,
    #[sea_orm(entity = "super::substance_route_of_administration::Entity")]
    SubstanceRouteOfAdministration,
    #[sea_orm(entity = "super::substance_synonym::Entity")]
    SubstanceSynonym,
    #[sea_orm(entity = "super::substance_tolerance::Entity")]
    SubstanceTolerance,
}
