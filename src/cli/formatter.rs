...
pub trait Formatter: Serialize + Sized {
...
pub trait TabledFormatter: Formatter + Tabled {
...
pub struct FormatterVector<T: TabledFormatter>(Vec<T>);

impl<T: TabledFormatter> FormatterVector<T> {
