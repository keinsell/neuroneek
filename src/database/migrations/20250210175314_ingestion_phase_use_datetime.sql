...
INSERT INTO `new_ingestion_phase` (`id`, `ingestion_id`, `classification`, `start_date_min`, `start_date_max`, `end_date_min`, `end_date_max`, `common_dosage_weight`, `duration_min`, `duration_max`, `notes`, `created_at`, `updated_at`) SELECT `id`, `ingestion_id`, `classification`, `start_date_min`, `start_date_max`, `end_date_min`, `end_date_max`, `common_dosage_weight`, `duration_min`, `duration_max`, `notes`, `created_at`, `updated_at` FROM `ingestion_phase`;
