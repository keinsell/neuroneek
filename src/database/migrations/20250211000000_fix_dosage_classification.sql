...
INSERT INTO `new_ingestion` (`id`, `substance_name`, `route_of_administration`, `dosage`, `dosage_classification`, `ingested_at`, `updated_at`, `created_at`)
SELECT `id`, `substance_name`, `route_of_administration`, `dosage`, `dosage_classification`, `ingested_at`, `updated_at`, `created_at`
FROM `ingestion`;
